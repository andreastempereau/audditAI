          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                id="rememberMe"
                type="checkbox"
                className="h-4 w-4 text-primary focus:ring-primary border-muted-300 dark:border-muted-700 rounded"
                disabled={isLoading}
              />
              <label htmlFor="rememberMe" className="ml-2 block text-sm text-muted-700 dark:text-muted-300">
                Remember me
              </label>
            </div>
